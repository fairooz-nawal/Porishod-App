    ...
    return (
        <div className='max-w-full md:max-w-5xl lg:max-w-7xl mx-auto p-4 text-center py-[50px] md:py-[100px] lg:py-[100px]'>
            <div className="w-full md:w-3/4 lg:w-3/4 mx-auto p-5 space-y-4">
                <p className='text-yellow-900 font-semibold text-2xl'>Our Partners</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-5 md:p-10 lg:p-10 ">
                <Slide direction="left">
                    <div className="space-y-4 border-3 border-blue-500 text-gray-800 rounded-2xl p-4 hover:bg-blue-500 hover:text-white">
                        <img className='w-full lg:w-[300px] lg:h-[170px] rounded-2xl border-2 border-gray-400' src={card1} alt="" />
                    ...
                    <div className="space-y-4 border-3 border-yellow-300 text-gray-800 rounded-2xl p-4 hover:bg-yellow-300 hover:text-white">
                        <img className='w-full lg:w-[300px] lg:h-[170px] rounded-2xl border-2 border-gray-400' src={card2} alt="" />
                        <div className="h-[250px] space-y-4">
                            <h1 className=' text-lg md:text-xl lg:text-xl font-bold'>NESCO - Empowering Your Home and Business</h1>
                            <p className=''>We have partnered with NESCO to provide you with convenient and secure electricity bill payment options. Our app allows you to pay your NESCO electricity bills quickly and easily, saving you time and hassle.</p>
                        </div>
                    </div>
                </Slide>
                <Slide direction="right">
                    <div className="space-y-4 border-3 border-green-500 text-gray-800 rounded-2xl p-4 hover:bg-green-500 hover:text-white">
                        <img className='w-full lg:w-[300px] lg:h-[170px] rounded-2xl border-2 border-gray-400' src={card3} alt="" />
                        <div className="h-[250px] space-y-4">
                    ...
                    <div className="space-y-4 border-3 border-purple-500 text-gray-800 rounded-2xl p-4 hover:bg-purple-500 hover:text-white">
                        <img className='w-full lg:w-[300px] lg:h-[170px] rounded-2xl border-2 border-gray-400' src={card4} alt="" />
                        <div className="h-[250px] space-y-4">
